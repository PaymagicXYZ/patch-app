    ...
    <footer className="mt-28">
      <div className="mb-6 flex w-full flex-col items-center gap-6 px-5 py-4 md:flex-row md:gap-2">
        <div className="flex w-full flex-1 flex-wrap justify-around text-gray-700 lg:flex-[2_2_0%]">
          <Link href="https://launch.mirror.xyz/Kwb5Cx_Uj0rrTtR-pnJT0WrVBYa_X-iVpEb1x7SSPNE">About</Link>
          <Link href="https://airtable.com/shrGrEOaBB2BVM7m7">Bugs or Feedback</Link>
          <Link href="https://dune.com/corbpage/patch-wallet-tracker-v0">Analytics</Link>
