...
export const UserLookupForm = ({ className, ...props }: InputProps) => {
  ...
  return (
    <div className="flex w-full gap-2 sm:w-4/6 sm:max-w-[520px]">
      <Input
        ...
        onChange={(e) => withDebounce('query', e.target.value)}
        leftButton={<SelectSocialProvider onChange={(val) => modifyQueryParams('provider', val)} />}
        type="text"
